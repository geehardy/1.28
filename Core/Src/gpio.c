...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : BEEP_Pin WIFI_NRST_Pin Output_LCDRES_Pin Output_LCDBLK_Pin */
  GPIO_InitStruct.Pin = BEEP_Pin|WIFI_NRST_Pin|Output_LCDRES_Pin|Output_LCDBLK_Pin;
  ...
  /*Configure GPIO pins : Input_LK1_Pin Input_LK2_Pin PB6 PB7
                           PB8 PB9 */
  GPIO_InitStruct.Pin = Input_LK1_Pin|Input_LK2_Pin|GPIO_PIN_6|GPIO_PIN_7
